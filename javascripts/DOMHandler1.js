...
for (let i = 0; i < allWeapons.length-11; i++) {
  ...
  $('#weapon-row').append(`<div class="card__button"><a class="class__link btn btn--small btn--blue" href="#"><span class="btn__prompt">></span><span class="btn__text">${currentWeapon}</span></a></div>`)
}
